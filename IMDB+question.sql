...
SELECT name AS actor_name, any_value(total_votes) AS total_votes,
			Count(r.movie_id) as movie_count,
...
SELECT name AS actress_name, any_value(total_votes) AS total_votes,
			Count(r.movie_id) as movie_count,
